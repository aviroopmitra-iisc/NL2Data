...
class ManagerAgent(BaseAgent):
    ...
    def run(self, board: Blackboard) -> Blackboard:
        ...
        try:
            ...
            def fix_none_params(data: dict) -> dict:
                """Fix common LLM error: convert None params to empty dict."""
            ...
            board.requirement_ir = call_llm_with_retry(
                messages,
                RequirementIR,
                pre_process=fix_none_params
            )
